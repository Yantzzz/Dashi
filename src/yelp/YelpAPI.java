...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "VG5ywMxAoIkphtpM9WrAvw";
	private static final String CLIENT_SECRET = "GmEHm9YcJtXtsHXcDXr31aT8mhkPcsYCCRdiCpCYVkjFDLxGumlCXDnBwcgTsKUm";
	...
	private JSONObject obtainAccessToken() {
		try {
			...
			//parse response to stringbuffer
			String inputLine;
